 ...
 */
class PhpInterface extends PhpClassLike
{
    /**
     * our constructor
     *
     * @param PhpInerfaceName $fqcn
     *        the fully-qualified interface name
     */
    public function __construct(PhpScope $scope, PhpInterfaceName $fqcn)
    {
    ...
    {
        return PhpContextTypes::INTERFACE_CONTEXT;
    }
}

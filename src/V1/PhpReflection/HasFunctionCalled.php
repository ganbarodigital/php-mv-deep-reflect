...
/**
 * does the context contain a named function?
 */
class HasFunctionCalled
{
     ...
     * @return boolean
     *         - `true` if the context contains the named function
     *         - `false` otherwise
     */
    public static function check(string $name, PhpFunctionContainer $context) : bool
    {
        $functions = GetAllFunctions::from($context);
        return isset($functions[$name]);
    }
}

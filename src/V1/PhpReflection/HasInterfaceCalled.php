...
class HasInterfaceCalled
{
     ...
     * @return boolean
     *         - `true` if the context contains the named interface
     *         - `false` otherwise
     */
    public static function check(string $name, PhpInterfaceContainer $context) : bool
    {
        $interfaces = GetAllInterfaces::from($context);
        return isset($interfaces[$name]);
    }
}

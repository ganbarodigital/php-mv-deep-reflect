...
use GanbaroDigital\DeepReflection\V1\PhpContexts\PhpFunctionLike;
...
/**
 * get a list of all parameters from a function or method
 */
class GetAllParameters
{
    ...
    /**
     * get a list of all parameters from a given context
     *
     * @param  PhpFunctionLike $context
     *         the context to extract from
     * @return PhpFunctionLikeParameter[]
     */
    public static function from(PhpFunctionLike $context) : array
    {
        return $context->getChildrenByType(PhpFunctionLikeParameter::class);
    }
}

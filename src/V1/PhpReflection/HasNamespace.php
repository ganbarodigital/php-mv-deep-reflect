...
class HasNamespace
{
     ...
     * @return boolean
     *         - `true` if the context contains the named namespace
     *         - `false` otherwise
     */
    public static function check(string $name, PhpNamespaceContainer $context) : bool
    {
        $namespaces = GetAllNamespaces::from($context);
        return isset($namespaces[$name]);
    }
}

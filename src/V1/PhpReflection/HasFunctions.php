...
/**
 * does the context contain any functions at all?
 */
class HasFunctions
{
     ...
     * @return boolean
     *         `true` if the context has at least one function defined
     *         `false` otherwise
     */
    public static function check(PhpFunctionContainer $context) : bool
    {

...
/**
 * does the context contain a named trait?
 */
class HasTraitCalled
{
     ...
     * @return boolean
     *         - `true` if the context contains the named trait
     *         - `false` otherwise
     */
    public static function check(string $name, PhpTraitContainer $context) : bool
    {

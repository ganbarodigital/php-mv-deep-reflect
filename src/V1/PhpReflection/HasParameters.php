...
/**
 * does the context contain any parameters at all?
 */
class HasParameters
{
     ...
     * @return boolean
     *         `true` if the context has at least one param defined
     *         `false` otherwise
     */
    public static function check(PhpParameterContainer $context) : bool
    {

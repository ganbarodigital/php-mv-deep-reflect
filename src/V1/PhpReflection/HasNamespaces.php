...
/**
 * does the context contain any namespaces at all?
 */
class HasNamespaces
{
     ...
     * @return boolean
     *         `true` if the context has at least one namespace defined
     *         `false` otherwise
     */
    public static function check(PhpNamespaceContainer $context) : bool
    {

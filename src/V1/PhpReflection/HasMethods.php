...
/**
 * does the context contain any methods at all?
 */
class HasMethods
{
     ...
     * @return boolean
     *         `true` if the context has at least one method defined
     *         `false` otherwise
     */
    public static function check(PhpMethodContainer $context) : bool
    {

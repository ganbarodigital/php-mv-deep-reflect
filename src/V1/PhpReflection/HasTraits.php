...
/**
 * does the context contain any traits at all?
 */
class HasTraits
{
     ...
     * @return boolean
     *         `true` if the context has at least one trait defined
     *         `false` otherwise
     */
    public static function check(PhpTraitContainer $context) : bool
    {

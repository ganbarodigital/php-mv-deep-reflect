...
/**
 * does the context contain a named method?
 */
class HasMethodCalled
{
     ...
     * @return boolean
     *         - `true` if the context contains the named method
     *         - `false` otherwise
     */
    public static function check(string $name, PhpMethodContainer $context) : bool
    {

...
/**
 * get a list of all methods from a given context
 */
class GetAllMethods
{
     ...
     * @return PhpMethod[]
     */
    public static function from(PhpMethodContainer $context) : array
    {
        return $context->getChildrenByType(PhpMethod::class);
    }
}

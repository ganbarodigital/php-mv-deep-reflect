...
trait AddMethodsToContainer
{
    protected function addMinimalMethods(PhpContexts\PhpContext $unit)
    {
        ...
        PhpReflectors\ReflectSourceFile::from(
            __DIR__ . '/BasicGlobalExamples/MinimalClassFooWithMethods.php',
            $unit->getScope()
        );
    }

    protected function addMinimalNamespacedMethods(PhpContexts\PhpContext $unit)
    {
        PhpReflectors\ReflectSourceFile::from(
            __DIR__ . '/BasicNamespacedExamples/MinimalClassBarWithMethods.php',
            $unit->getScope()
        );
        PhpReflectors\ReflectSourceFile::from(
            __DIR__ . '/BasicNamespacedExamples/MinimalClassFooWithMethods.php',
            $unit->getScope()
        );
    }
}
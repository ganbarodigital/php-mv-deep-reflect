...
use GanbaroDigital\DeepReflection\V1\PhpContexts\PhpInterfaceName;
use PhpUnit\Framework\TestCase;

/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpContexts\PhpInterfaceName
 */
class PhpInterfaceNameTest extends TestCase
{
    /**
     * @covers ::__construct
     */
    public function test_can_instantiate()
    {
        ...
        $unit = new PhpInterfaceName($expectedValue);

        // ----------------------------------------------------------------
        // test the results

        $this->assertInstanceOf(PhpInterfaceName::class, $unit);
    }

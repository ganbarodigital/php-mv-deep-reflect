...
/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpContexts\PhpClassLikeName
 */
class PhpClassLikeNameTest extends TestCase
{
    /**
     * @covers ::__construct
     */
    public function test_can_instantiate()
    {
        ...
        $unit = new PhpClassLikeName($expectedValue);

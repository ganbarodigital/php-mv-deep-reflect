...
use GanbaroDigital\DeepReflection\V1\PhpContexts\PhpClassName;
use PhpUnit\Framework\TestCase;

/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpContexts\PhpClassName
 */
class PhpClassNameTest extends TestCase
{
    ...
    public function test_can_instantiate()
    {
        ...
        $unit = new PhpClassName($expectedValue);

        // ----------------------------------------------------------------
        // test the results

        $this->assertInstanceOf(PhpClassName::class, $unit);
    }

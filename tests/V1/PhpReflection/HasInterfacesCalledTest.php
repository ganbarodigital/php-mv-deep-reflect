...
use GanbaroDigital\DeepReflection\V1\PhpReflection\HasInterfacesCalled;
...
/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpReflection\HasInterfacesCalled
 */
class HasInterfacesCalledTest extends TestCase
{
     ...
     * @covers ::check
     */
    public function test_returns_true_if_named_interfaces_in_context()
    {
        // ----------------------------------------------------------------
        // setup your test
        ...
        $this->assertTrue(HasInterfacesCalled::check(['FooInterface'], $context));
        $this->assertTrue(HasInterfacesCalled::check(['FooInterface', 'BarInterface'], $context));
    }

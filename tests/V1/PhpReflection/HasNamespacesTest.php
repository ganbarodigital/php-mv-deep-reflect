...
use GanbaroDigital\DeepReflection\V1\PhpReflection\HasNamespaces;
...
/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpReflection\HasNamespaces
 */
class HasNamespacesTest extends TestCase
{
     ...
     * @covers ::check
     */
    public function test_returns_false_when_no_namespaces_in_context()
    {
        // ----------------------------------------------------------------
        // setup your test
        ...
        $actualResult = HasNamespaces::check($context);
     ...
     * @covers ::check
     */
    public function test_returns_true_if_any_namespaces_in_context()
    {
        // ----------------------------------------------------------------
        // setup your test
        ...
        $this->assertTrue(HasNamespaces::check($context));
    }
}
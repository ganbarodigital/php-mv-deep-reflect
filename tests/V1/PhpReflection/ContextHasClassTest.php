...
use GanbaroDigital\DeepReflection\V1\PhpReflection\ContextHasClass;
...
/**
 * @coversDefaultClass GanbaroDigital\DeepReflection\V1\PhpReflection\ContextHasClass
 */
class ContextHasClassTest extends TestCase
{
    ...
    public function test_can_be_instantiated()
    {
        ...
        $unit = new ContextHasClass($classContainer);

        // ----------------------------------------------------------------
        // test the results

        $this->assertInstanceOf(ContextHasClass::class, $unit);
    }
    ...
    public function test_can_check_if_named_class_in_context()
    {
        ...
        $this->assertTrue(ContextHasClass::check($classContainer, 'FooClass'));
        $this->assertFalse(ContextHasClass::check($classContainer, 'not_a_class'));
